...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/admin-dashboard-stats.css?v=2">
        ...
        <div class="container d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="${pageContext.request.contextPath}/home" style="text-decoration: none;">
                    <span style="color: #C92127; font-weight: 900; font-size: 28px;">MIND</span><span style="color: white; font-weight: 900; font-size: 28px;">BOOK</span>
                </a>
                <span style="color: white; margin-left: 10px; font-weight: bold; font-size: 16px;">| STAFF PORTAL</span>
            </div>
                    ...
                    <h2>
                        <c:choose>
                            <c:when test="${not empty todayRevenue}">
                                <fmt:formatNumber value="${todayRevenue}" type="currency" currencySymbol="đ"/>
                            </c:when>
