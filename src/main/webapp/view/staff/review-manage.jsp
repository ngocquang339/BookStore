                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <div class="border-start border-2 border-secondary ps-4">
                            <h2 class="fw-bold brand-color mb-1"><i class="fa-solid fa-comments me-2"></i>Quản lý Đánh
                                giá</h2>
                                        ...
                                        <c:forEach items="${listReviews}" var="r">
                                            <tr id="comment-${r.reviewId}">
                                                ...
                                                <td class="align-middle">
                                                    <a href="${pageContext.request.contextPath}/staff/reviews?userId=${r.userId}"
                                                        class="text-decoration-none d-inline-block"
                                                        title="Xem lịch sử đánh giá của khách hàng này">
                                                ...
                                                <td class="comment-cell align-middle" style="max-width: 300px;">
                                                    ...
                                                    <c:if test="${not empty r.staffReply}">
                                                        <div class="p-2 mt-2 bg-light rounded border-start border-3 border-danger"
                                                            ...
                                                            <strong class="text-danger">↳ Phản hồi của
                                                                Shop:</strong><br>
                                        ...
                                        <c:if test="${empty listReviews}">
                                            <tr>
                                                <td colspan="7" class="text-center py-5 text-muted"><i
                                                        class="fa-regular fa-comments fs-1 mb-3 text-light"></i><br>Chưa
                                                    có
