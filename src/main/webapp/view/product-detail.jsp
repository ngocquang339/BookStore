                                    ...
                                    <div class="button-group" style="display: flex; gap: 15px; width: 100%;">
                                        ...
                                        <c:if test="${sessionScope.user != null}">
                                            <button type="button" class="btn btn-outline-danger" data-bs-toggle="modal"
                                                data-bs-target="#addToCollectionModal" title="Lưu vào Giá sách"
                                        ...
                                        <c:if test="${sessionScope.user == null}">
                                            <a href="${pageContext.request.contextPath}/login"
                                                class="btn btn-outline-danger" title="Vui lòng đăng nhập để lưu sách"
                                                style="width: 50px; height: 50px; padding: 0; display: flex; align-items: center; justify-content: center; border-radius: 8px; border: 2px solid #dc3545; flex-shrink: 0;">
                                                <i class="fa-regular fa-heart" style="font-size: 20px;"></i>
                                            </a>
                                        </c:if>
                            ...
                            <div class="product-info-column"
                                ...
                                <div class="product-info-box white-box" style="padding: 20px; border-radius: 8px;">
                                    ...
                                    <%--=====================================--%>
                                        ...
                                        <div
                                            ...
                                            <div>Nhà cung cấp:
                                                <span style="color:#2489F4; text-decoration:none;">${book.supplier}
                                                </span>
                                            </div>
                                ...
                                <div class="product-action-box white-box" style="padding: 20px; border-radius: 8px;">
                                    ...
                                    <div style="font-size: 14px; margin-bottom: 15px;">
                                        Giao hàng đến: <strong id="displayAddressText">Chọn địa chỉ để ước tính thời
                                            gian giao hàng</strong>
                                    ...
                                    <%-- Trường hợp 1: Có đánh giá --%>
                                                            ...
                                                            <c:if test="${sessionScope.user != null}">
                                                                <div class="dropdown"
                                                                    ...
                                                                    <ul
                                                                        ...
                                                                        <c:choose>
                                                                            <%-- NẾU LÀ CHỦ NHÂN BÌNH LUẬN -> CHO SỬA &
                                                                                XÓA --%>
                                                                                <c:when
                                                                                ...
                                                                                <%-- NẾU LÀ NGƯỜI KHÁC ĐỌC -> CHỈ CHO TỐ
                                                                                    CÁO --%>
                                                                                    <c:otherwise>
                                                                                        <li>
                                                            ...
                                                            <div id="review-edit-form-${r.reviewId}"
                                                                ...
                                                                <form class="edit-review-form">
                                                                    ...
                                                                    <textarea name="comment" class="form-control"
                                                                        rows="2" required>${r.comment}</textarea>
                                                                    ...
                                                                    <div style="margin-top: 10px; text-align: right;">
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            style="background-color: #C92127;">Lưu thay
                                                                            đổi
                                                                        </button>
                                                                    </div>
                                                                </form>
                                        ...
                                        <c:otherwise>
                                            <div
                                                ...
                                                Chưa có đánh giá nào cho sản phẩm này.<br>Hãy là người đầu tiên nhận
                                                xét!
                                            </div>
                                        </c:otherwise>
                                </c:choose>
                        ...
                        <div id="addressModalOverlay" class="address-modal-overlay" style="display: none;">
                            <div class="address-modal-box">
                                ...
                                <label class="address-radio-label">
                                    ...
                                    Giao hàng đến <span style="color: #777; margin-left: 5px;"> Triều Khúc, Thanh Xuân,
                                        Hà Nội</span>
                                </label>
