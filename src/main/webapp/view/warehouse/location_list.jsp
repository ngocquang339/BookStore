        ...
        <body>
                        ...
                        <form action="location" method="post" class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="categoryId" id="${modalType}-categoryId" class="form-select" required>
            ...
            <script>
                ...
                function loadEditData(id, zone, rack, shelf, categoryId, description) {
                    ...
                    document.getElementById('edit-categoryId').value = categoryId ? categoryId : "";
                    document.getElementById('edit-description').value = description;
                }
            </script>

            <!-- CSS đã chuyển xuống dưới -->
            <style>
                body {
