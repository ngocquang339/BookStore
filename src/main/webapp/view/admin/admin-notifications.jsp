            ...
            fetch('${pageContext.request.contextPath}/admin/api/notifications')
                ...
                .then(data => {
                    ...
                    data.forEach(notification => {
                        ...
                        // Clicking the text takes the Admin straight to the correct page!
                       // Added ${pageContext.request.contextPath} right before the link!
                        alertBox.innerHTML = `
    <div style="flex: 1; cursor: pointer;" onclick="window.location.href='${pageContext.request.contextPath}` + notification.link + `'">
        <strong><i class="fa-solid fa-bell"></i> Action Required!</strong><br>
        <span style="font-size: 0.9em; color: #0d6efd; text-decoration: underline;">` + notification.message + `</span>
    </div>
