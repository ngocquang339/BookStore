...
<body>
    ...
    <div class="page-container">
        ...
        <form action="${pageContext.request.contextPath}/admin/product/list" method="get" class="filter-bar">
            <input type="text" name="keyword" class="search-input" placeholder="Search by book title..." value="${searchKeyword}"> 
            
            <select name="cid" class="filter-select">
                <option value="all" ${searchCid=='all' || empty searchCid ? 'selected' : '' }>All Categories</option>
            ...
            <c:if test="${not empty searchKeyword or (not empty searchCid and searchCid != 'all')}">
                <a href="${pageContext.request.contextPath}/admin/product/list" style="color:#666; text-decoration:none; font-size:14px;">Clear</a>
            </c:if>
        </form>
        ...
        <div class="table-responsive">
            <table class="admin-table" id="productTable">
                <thead>
                    <tr>
                        <th class="sortable" onclick="sortTable(0, 'number')" style="width: 50px;">
                        ...
                        <th class="sortable" onclick="sortTable(2, 'string')">
                            Book Details <i class="fa-solid fa-sort"></i>
                        </th>
                        
                        <th class="sortable" onclick="sortTable(3, 'price')">
                        ...
                        <th class="sortable" onclick="sortTable(5, 'string')">
                ...
                <tbody>
                    <c:forEach items="${listBooks}" var="b">
                        <tr class="${!b.active ? 'row-hidden' : ''}">
                            <td>${b.id}</td>
                            <td>
                                <div style="width: 50px; height: 75px; overflow: hidden; border-radius: 4px; border: 1px solid #eee;">
                                    <img class="table-img"
                            ...
                            <td>
                                ...
                                <div style="color: #666; font-size: 0.9em;"><i class="fa-solid fa-user-pen"></i> ${b.author}</div>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <c:if test="${!b.active}">
                                    <span class="status-hidden"><i class="fa-solid fa-eye-slash"></i> Hidden</span>
                                </c:if>
                            </td>
                            <td>
