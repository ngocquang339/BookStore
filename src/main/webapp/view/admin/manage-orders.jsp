                                                ...
                                                <td>
                                                    <c:choose>
                                                        ...
                                                        <c:when test="${o.status == 3}">
                                                            ...
                                                            <%-- Add the note directly under the badge --%>
                                                                <c:if test="${not empty o.statusNote}">
                                                                    <div
                                                                        style="font-size: 0.85em; color: #28a745; margin-top: 5px; max-width: 200px; word-wrap: break-word;">
                                                        ...
                                                        <c:when test="${o.status == 0}">
                                                            ...
                                                            <%-- Add the note directly under the badge --%>
                                                                <c:if test="${not empty o.statusNote}">
                                                                    <div
                                                                        style="font-size: 0.85em; color: #dc3545; margin-top: 5px; max-width: 200px; word-wrap: break-word;">
