            ...
            <div class="container">
                <div class="logo">
                    <a href="${pageContext.request.contextPath}/home" style="text-decoration: none;">
                        <span style="color: #C92127; font-weight: 900; font-size: 28px;">MIND</span><span
                            style="color: #333; font-weight: 900; font-size: 28px;">BOOK</span>
                    </a>
                </div>
                            ...
                            <div class="filter-grid">
                                ...
                                <div class="filter-group">
                                    ...
                                    <label class="checkbox-item"><input type="checkbox" name="cid" value="1"> Văn
                                        học</label>
                                    <label class="checkbox-item"><input type="checkbox" name="cid" value="2"> Kinh
                                        tế</label>
                                    <label class="checkbox-item"><input type="checkbox" name="cid" value="3"> Thiếu
                                        nhi</label>
                                    <label class="checkbox-item"><input type="checkbox" name="cid" value="4"> Kỹ năng
                                        sống</label>
                                </div>
                                <div class="filter-group">
                ...
                <div class="search-box">
                    <form action="search" method="get" style="display: flex; width: 100%; position: relative;">
                        ...
                        <button type="submit"
                            style="position: absolute; right: 0; top: 0; bottom: 0; background: #C92127; border: none; color: white; padding: 0 15px; border-radius: 0 4px 4px 0;">
                    ...
                    <div class="icon-item user-account">
                        ...
                        <div class="dropdown-content">
                            <c:if test="${sessionScope.user == null}">
                                ...
                                <a href="${pageContext.request.contextPath}/register" class="btn-auth-register">Đăng
                                    ký</a>
                            </c:if>
                        ...
                        <a href="${pageContext.request.contextPath}/logout" class="dropdown-link logout-link">
                            ...
                            <c:if test="${sessionScope.user != null}">
                                ...
                                <c:if test="${sessionScope.user.role == 3}">
                                    ...
                                    <h6 class="dropdown-header text-uppercase fw-bold text-primary px-3"
                                        style="font-size: 0.75rem; letter-spacing: 0.5px;">
                                        <i class="fa-solid fa-briefcase me-1"></i> Nghiệp vụ Sale
                                    </h6>

                                    <a href="${pageContext.request.contextPath}/staff/customers"
                                        class="dropdown-item py-2 fw-bold" style="color: #0d6efd;">
                                        <i class="fa-solid fa-users-viewfinder me-2"
                                            style="width: 20px; text-align: center;"></i> Hỗ trợ Khách hàng
                                    </a>

                                    <a href="${pageContext.request.contextPath}/staff/reviews"
                                        class="dropdown-item py-2 fw-bold" style="color: #ffc107;">
                                        <i class="fa-regular fa-comments me-2"
                                            style="width: 20px; text-align: center;"></i> Quản lý Đánh giá
                                    </a>
                                </c:if>
