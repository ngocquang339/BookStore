...
public class LocationDAO extends DBContext {
    ...
    public List<String> getAllZones() {
        ...
        String sql = "SELECT DISTINCT zone FROM Warehouse_Locations ORDER BY zone ASC";
    ...
    public List<Location> getLocationsByZone(String zone) {
        ...
        try (Connection conn = getConnection();
            ...
            ps.setString(1, zone.toUpperCase());
            ResultSet rs = ps.executeQuery();
    ...
    public void addLocation(Location l) throws Exception {
        ...
        try (Connection conn = getConnection();
            ...
            if (l.getCategoryId() > 0)
                ps.setInt(4, l.getCategoryId());
            else
    ...
    public void deleteLocation(int id) throws Exception {
        ...
        try (Connection conn = getConnection();
            ...
            if (e.getErrorCode() == 547)
                throw new Exception("Không thể xóa kệ này vì đang có sách nằm trên kệ!");
            throw new Exception("Lỗi DB: " + e.getMessage());
        }
    }
}