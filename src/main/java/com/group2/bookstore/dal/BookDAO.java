...
public class BookDAO extends DBContext {
    ...
    public List<Category> getCategories() {
        ...
        // Nếu bảng bạn chưa có cột ảnh, bạn có thể hardcode ảnh trong Java hoặc thêm
        // cột vào DB sau.
    ...
    public int countBooks(String keyword, int cid, String author, String publisher, double minPrice, double maxPrice,
        ...
        // Keeping the JOIN ensures the count matches exactly, even if filters involve
        // category logic later
        sql.append("LEFT JOIN Categories c ON b.category_id = c.category_id ");
        sql.append("WHERE 1=1 ");
