...
Tải git(Bắt buộc)
https://git-scm.com/download/win -> Chọn click here to download, tải xong mở file đó lên, nhấn next hết cho đến khi có chữ install là được
...
3. Sau khi ae code xong chức năng của mình, thì dùng các lệnh sau để push code lên git:
...
4. Sau khi push xong, code vẫn nằm riêng ở nhánh con. Để gộp nó vào dự án chính (main), ae làm như sau:
