...
4. Sau khi ae code xong chức năng của mình, thì dùng các lệnh sau để push code lên git:
   git add .
   git commit -m "Hoan thanh chuc nang dang nhap"
   git push origin (tên chức năng)
5. Sau khi push xong, code vẫn nằm riêng ở nhánh con. Để gộp nó vào dự án chính (main), ae làm như sau:
